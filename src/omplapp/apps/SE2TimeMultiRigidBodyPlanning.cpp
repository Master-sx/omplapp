...
ompl::app::SE2TimeMultiRigidBodyPlanning::SE2TimeMultiRigidBodyPlanning(unsigned int n) :
    AppBase<GEOMETRIC>(base::StateSpacePtr(new base::CompoundStateSpace()), Motion_2D), n_(n)
{
    ...
    // Adding in TimeStateSpace
    si_->getStateSpace()->as<base::CompoundStateSpace>()->addSubspace(base::StateSpacePtr(new base::TimeStateSpace()), 1.0);
}

void ompl::app::SE2TimeMultiRigidBodyPlanning::inferEnvironmentBounds(void)
{
...
void ompl::app::SE2TimeMultiRigidBodyPlanning::inferProblemDefinitionBounds(void)
{
...
ompl::base::ScopedState<> ompl::app::SE2TimeMultiRigidBodyPlanning::getDefaultStartState(void) const
{
...
const ompl::base::State* ompl::app::SE2TimeMultiRigidBodyPlanning::getGeometricComponentStateInternal(const ompl::base::State* state, unsigned int index) const
{
    assert (index < n_);
